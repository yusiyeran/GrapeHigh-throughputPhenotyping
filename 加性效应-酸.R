...
pheno.tangsuan$TotalAcid2011 = pheno.tangsuan$TartaricNAacid2011+pheno.tangsuan$MalicNAacid2011
pheno.tangsuan$TotalAcid2012 = pheno.tangsuan$TartaricNAacid2012+pheno.tangsuan$MalicNAacid2012
pheno.tangsuan$TotalAcid2013 = pheno.tangsuan$TartaricNAacid2013+pheno.tangsuan$MalicNAacid2013
...
pdf("add_trait distribution_TotalAcid_V15.0.pdf",width = 10,height = 6)
for (ii in c("6-5939415","17-6468398")) { #TotalAcidSNP2011$Marker
  # # ii = "6−5939415"
...
setwd("G:\\OneDrive\\C5.23=基因芯片和高通量表型组\\10.图-加性效应\\plotdata-TotalAcid2")

pdf("add_trait distribution_LTE_V8.0.pdf",width = 8,height = 6)
for (i_year in c(2011:2013)) {
  

chr2 = read.csv(paste("TotalAcid",i_year,"_6-5939415_1.csv",sep = ""))
chr7 = read.csv(paste("TotalAcid",i_year,"_17-6468398_1.csv",sep = "")) #7-4404321
...
#删除0值行
if (length(which(chr2_7[,4]==0))>0){
  chr2_7 =chr2_7[-which(chr2_7[,4]==0),]
}
# chr2_7[,4] = chr2_7[,4]*-1
# view(chr2_7)
...
chr2_7_group = chr2_7_group0[order(chr2_7_group0[,5],decreasing = T),]
